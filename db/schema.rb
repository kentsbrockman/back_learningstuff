...
ActiveRecord::Schema.define(version: 2021_03_24_091509) do
  ...
  create_table 'one_time_payments', force: :cascade do |t|
    ...
    t.index ['subscription_id'],
            name: 'index_one_time_payments_on_subscription_id'
  end
  ...
  create_table 'progress_lessons', force: :cascade do |t|
    ...
    t.index ['progress_state_id'],
            name: 'index_progress_lessons_on_progress_state_id'
  end
  ...
  create_table 'subscriptions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['learning_path_id'],
            name: 'index_subscriptions_on_learning_path_id'
