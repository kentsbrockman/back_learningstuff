...
jsnoob =
  LearningPath.create(title: 'Javascript for noobs', price_in_cents: 5000)
...
codewars =
  LearningPath.create(title: 'Code Wars for training', price_in_cents: 5000)
codewars.courses <<
  Course.find_by(title: 'Train your coding spirit with Code Wars')
codewars.categories << [Category.find_by(title: 'Coding')]

jsadv = LearningPath.create(title: 'Advanced Javascript', price_in_cents: 5000)
...
student.subscriptions.create(
  learning_path: LearningPath.find_by(title: 'Become a web developer')
)
student
  .subscriptions
  .last
...
student.subscriptions.create(
  learning_path: LearningPath.find_by(title: 'Get started with web development')
)
student
  .subscriptions
  .last
